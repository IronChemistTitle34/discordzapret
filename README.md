...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" alt="Discord Connecting — обход без VPN" height=28 /> <a href="https://github.com/IronChemistTitle34/">IronChemistTitle34</a><a href="https://github.com/IronChemistTitle34/discordzapret">/discordzapret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" alt="YouTube в сборке zapret" height=28 />

### discordzapret · Запрет Discord · connecting / RTC · обход DPI без VPN

**discordzapret** — обход блокировок **Discord** (голос / RTC / connecting) без VPN

[Скачать discordzapret](https://github.com/IronChemistTitle34/discordzapret/releases/latest) — Windows 10/11, без VPN
...
<!-- yandex-aeo -->
## Что делает discordzapret с Discord

**discordzapret** — готовый обход DPI для Discord на Windows 10/11: распаковали архив, запустили стратегию от администратора, голосовой чат снова открывается.
...
После удачного запуска discordzapret не держите несколько стратегий сразу: один сервис лучше трёх «на всякий случай».

### Почему Discord пишет Connecting и не заходит в голосовой?

Connecting почти всегда DPI, а не «сломанный Discord». После запуска discordzapret закройте клиент и зайдите в канал заново.

### Нужен ли VPN, чтобы обойти блокировку Discord?

Нет. discordzapret не меняет маршрут и не подменяет адрес. Нужен только Windows 10/11 x64 и запуск `.bat` с правами администратора.

### Это бесплатно и какой Windows нужен?

Да, discordzapret без регистрации. Нужны Windows 10 или 11 x64. Установка не нужна: архив и `.bat`. Антивирус может ругаться на WinDivert — это драйвер фильтра, не вирус.
...
> Если вы наткнулись на что-то вне репозитория `IronChemistTitle34/discordzapret`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/IronChemistTitle34/discordzapret/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/IronChemistTitle34/discordzapret/issues/522)
...
- См. [#765](https://github.com/IronChemistTitle34/discordzapret/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/IronChemistTitle34/discordzapret/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/IronChemistTitle34/discordzapret/discussions/251)
...
- См. также [#252](https://github.com/IronChemistTitle34/discordzapret/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/IronChemistTitle34/discordzapret/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/IronChemistTitle34/discordzapret/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/IronChemistTitle34/discordzapret/blob/main/LICENSE.txt)
